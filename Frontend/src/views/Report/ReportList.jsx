...
function ReportList ({isAdmin, isSeller}) {
          ...
          <div className="flex items-center justify-center">
            ...
            {isSeller && (
                <>
                  ...
                  <Tooltip title={t ("Phản hồi báo cáo")} placement="top">
                    <IconButton
                        onClick={() => handleOpenEdit (row.original.id)}
                        disabled={row.original?.status === ReportStatus.COMPLETED.value || row.original?.response}
                    >
