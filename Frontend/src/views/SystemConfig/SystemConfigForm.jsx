...
function SystemConfigForm () {
  ...
  return (
      <CommonPopupV2
          ...
          noDialogContent
          title={(selectedRow?.id? t ("general.button.edit") : t ("general.button.add")) + ' ' + t ("navigation.admin.systemConfig")}
                    ...
                    <div className={"grid grid-cols-12 gap-2"}>
                      ...
                      <div className="col-span-12">
                        <CommonSelectInput
                            ...
                            name="type"
                            options={ValueType.getListData ()}
                            disabled
                        />
                      </div>
                      {initialValues?.type === ValueType.STRING.value && (
                          <div className="col-span-12">
                            <CommonTextField
                      ...
                      {initialValues?.type === ValueType.INTEGER.value && (
                          <div className="col-span-12">
                            <CommonNumberInput
                                label={t ("system-config.value")}
                                name="value"
                      ...
                      {initialValues?.type === ValueType.DECIMAL.value && (
                          <div className="col-span-12">
                            <CommonNumberInput
                                label={t ("system-config.value")}
                                name="value"
                      ...
                      {initialValues?.type === ValueType.DATE.value && (
                          <div className="col-span-12">
                      ...
                      {initialValues?.type === ValueType.BOOLEAN.value && (
                          <div className="col-span-12">
                            <CommonCheckBox
                                label={t ("system-config.value")}
                                name="value"
...
export default memo (observer (SystemConfigForm));
