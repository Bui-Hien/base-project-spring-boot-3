...
import AccountCategoryToolbar from "./AccountCategoryToolbar";

function AccountCategoryIndex () {
      ...
      <div className="content-index">
        <div className="">
          <CommonBreadcrumb routeSegments={[
            ...
            {name:t ("navigation.admin.accountCategory")}
          ]}/>
        </div>
        <div className="index-card grid grid-cols-12 px-4">
          <div className={"col-span-12"}>
            <AccountCategoryToolbar/>
          </div>
          <div className={"col-span-12"}>
            <AccountCategoryList/>
          </div>
...
export default memo (observer (AccountCategoryIndex));
