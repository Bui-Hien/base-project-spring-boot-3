...
function AccountCategoryForm (props) {
  ...
  const validationSchema = Yup.object ({
    ...
    type:Yup.number ().nullable ().required (t ("validation.required")),
    description:Yup.string ().nullable (),
    percentage:Yup.number ()
        .typeError (t ('validate.accountCategory.number'))   // khi nhập chữ
        .min (1, t ('validate.accountCategory.min'))
        .max (100, t ('validate.accountCategory.max'))
        .required (t ('validate.accountCategory.required')),
  });


  async function handleSaveForm (values) {
    await saveAccountCategory (values);
  }
  ...
  return (
      <CommonPopupV2
          ...
          noDialogContent
          title={(selectedRow?.id? t ("general.button.update") : t ("general.button.add")) + ' ' + t ("danh mục tài khoản")}
                    ...
                    <div className={"grid grid-cols-12 gap-2"}>
                      ...
                      <div className="col-span-12">
                        <CommonSelectInput
                            ...
                            name="type"
                            required
                            options={AccountCategoryType.getListData()}
                        />
                      </div>
                      <div className="col-span-12">
                        <CommonNumberInput
...
export default memo (observer (AccountCategoryForm));
