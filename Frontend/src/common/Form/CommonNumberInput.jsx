...
const MyNumberInput = ({
    ...
    const configTextfield = {
        ...
        value: value,
        id: name,
        onKeyDown: disabled ? undefined : handleKeyDown, // Ngăn nhập dữ liệu nếu readOnly
        onChange: disabled ? undefined : onChange, // Ngăn thay đổi giá trị nếu readOnly
        ...
        className: clsx(
            ...
            disabled && "read-only" // Thêm class "read-only" nếu readOnly = true
        ),
        inputProps: {
            ...inputProps,
            inputmode: "numeric",
            className: clsx(reportComponent && "text-align-right", inputProps?.className, disabled && "read-only"),
        },
    };
